...
/obj/item/reagent_containers/food/drinks/soda_cans/ms13
	...
	reagents_to_add = null // IMMERSION ANNOUNCEMENT: Drinks usually aren't filled to the literal top. Leave a bit less in there.
	foodtype = SUGAR
	isGlass = TRUE
	w_class = WEIGHT_CLASS_SMALL
	grid_height = 64
...
/obj/item/reagent_containers/food/drinks/soda_cans/ms13/nuka_cola
	...
	reagents_to_add = list(/singleton/reagent/consumable/ms13/nuka_cola = 40)
...
/obj/item/reagent_containers/food/drinks/soda_cans/ms13/nuka_dark
	...
	reagents_to_add = list(/singleton/reagent/consumable/ethanol/ms13/nuka_dark = 40)
...
/obj/item/reagent_containers/food/drinks/soda_cans/ms13/nuka_victory
	...
	reagents_to_add = list(/singleton/reagent/consumable/ms13/nuka_victory = 40)

/obj/item/reagent_containers/food/drinks/soda_cans/ms13/nuka_quantum
	name = "Nuka quantum bottle"
	desc = "A Nuka victory bottle. Made to sell off delicious soda to the masses."
	icon_state = "nuka_quantum"
	reagents_to_add = list(/singleton/reagent/consumable/ms13/nuka_quantum = 40)
...
/obj/item/reagent_containers/food/drinks/soda_cans/ms13/nuka_quartz
	...
	reagents_to_add = list(/singleton/reagent/consumable/ms13/nuka_quartz = 40)
...
/obj/item/reagent_containers/food/drinks/soda_cans/ms13/nuka_cherry
	...
	reagents_to_add = list(/singleton/reagent/consumable/ms13/nuka_cherry = 40)
...
/obj/item/reagent_containers/food/drinks/soda_cans/ms13/nuka_grape
	...
	reagents_to_add = list(/singleton/reagent/consumable/ms13/nuka_grape = 40)
...
/obj/item/reagent_containers/food/drinks/soda_cans/ms13/nuka_orange
	...
	reagents_to_add = list(/singleton/reagent/consumable/ms13/nuka_orange = 40)
...
/obj/item/reagent_containers/food/drinks/soda_cans/ms13/nuka_cranberry // Want a nuka cranberry?
	...
	reagents_to_add = list(/singleton/reagent/consumable/ms13/nuka_cranberry = 40)
...
/obj/item/reagent_containers/food/drinks/soda_cans/ms13/nuka_wild
	...
	reagents_to_add = list(/singleton/reagent/consumable/ms13/nuka_wild = 40)
...
/obj/item/reagent_containers/food/drinks/soda_cans/ms13/nuka_lime
	...
	reagents_to_add = list(/singleton/reagent/consumable/ms13/nuka_lime = 40)
...
/obj/item/reagent_containers/food/drinks/soda_cans/ms13/sarsaparilla
	...
	volume = 40
	reagents_to_add = list(/singleton/reagent/consumable/ms13/sunset_sarsaparilla = 35)
...
/obj/item/reagent_containers/food/drinks/bottle/ms13/attackby(obj/item/W, mob/user, params)
	...
	if(reagents)
		for(var/singleton/reagent/R in reagents.reagent_list)
			if(istype(R, /singleton/reagent/consumable/ethanol/ms13))
				var/singleton/reagent/consumable/ethanol/henny = R
				if(henny.volume >= 50 && henny.strength >= 40 && do_after(user, 1 SECONDS, user, interaction_key = DOAFTER_SOURCE_CRAFTING))
					...
					M.extra_POWER = round(henny.strength / 35)
...
/obj/item/reagent_containers/food/drinks/bottle/ms13/moonshine
	...
	volume = 100
	reagents_to_add = list(/singleton/reagent/consumable/ethanol/ms13/moonshine = 90)
	grid_height = 64
	grid_width = 64
...
/obj/item/reagent_containers/food/drinks/bottle/ms13/whiskey
	...
	icon_state = "whiskey"
	volume = 80
	reagents_to_add = list(/singleton/reagent/consumable/ethanol/ms13/whiskey = 75)
	grid_height = 96
	grid_width = 32
...
/obj/item/reagent_containers/food/drinks/bottle/ms13/vodka
	...
	icon_state = "vodka"
	volume = 70
	reagents_to_add = list(/singleton/reagent/consumable/ethanol/ms13/vodka = 65)
	grid_height = 96
	grid_width = 32
...
/obj/item/reagent_containers/food/drinks/bottle/ms13/tequila
	...
	icon_state = "tequila"
	volume = 70
	reagents_to_add = list(/singleton/reagent/consumable/ethanol/ms13/tequila = 65)
	grid_height = 96
	grid_width = 32
...
/obj/item/reagent_containers/food/drinks/bottle/ms13/kaluha
	...
	icon_state = "kaluha"
	volume = 70
	reagents_to_add = list(/singleton/reagent/consumable/ethanol/ms13/kaluha = 65)
	grid_height = 96
	grid_width = 32
...
/obj/item/reagent_containers/food/drinks/bottle/ms13/wine
	...
	icon_state = "wine"
	volume = 70
	reagents_to_add = list(/singleton/reagent/consumable/ethanol/ms13/wine = 65)
	grid_height = 96
	grid_width = 32
...
/obj/item/reagent_containers/food/drinks/bottle/ms13/champagne
	...
	volume = 70
	reagents_to_add = list(/singleton/reagent/consumable/ethanol/ms13/champagne = 65)
	grid_height = 96
	grid_width = 32
...
/obj/item/reagent_containers/food/drinks/bottle/ms13/cognac
	...
	icon_state = "cognac"
	volume = 55
	reagents_to_add = list(/singleton/reagent/consumable/ethanol/ms13/cognac = 50)
	grid_height = 96
	grid_width = 32
...
/obj/item/reagent_containers/food/drinks/bottle/ms13/nukashine
	...
	volume = 80
	reagents_to_add = list(/singleton/reagent/consumable/ethanol/ms13/nukashine = 75)
	grid_height = 96
	grid_width = 32
...
/obj/item/reagent_containers/food/drinks/bottle/ms13/gin
	...
	icon_state = "gin"
	volume = 80
	reagents_to_add = list(/singleton/reagent/consumable/ethanol/ms13/gin = 75)
	grid_height = 96
	grid_width = 32
...
/obj/item/reagent_containers/food/drinks/bottle/ms13/sake
	...
	icon_state = "sake"
	volume = 80
	reagents_to_add = list(/singleton/reagent/consumable/ethanol/ms13/sake = 75)
	grid_height = 96
	grid_width = 32
...
/obj/item/reagent_containers/food/drinks/bottle/ms13/vermouth
	...
	icon_state = "vermouth"
	volume = 70
	reagents_to_add = list(/singleton/reagent/consumable/ethanol/ms13/vermouth = 65)
	grid_height = 96
	grid_width = 32
...
/obj/item/reagent_containers/food/drinks/bottle/ms13/triple_sec
	...
	volume = 65
	reagents_to_add = list(/singleton/reagent/consumable/ethanol/ms13/triple_sec = 60)
	grid_height = 96
	grid_width = 32
...
/obj/item/reagent_containers/food/drinks/bottle/ms13/absinthe
	...
	icon_state = "absinthe"
	volume = 80
	reagents_to_add = list(/singleton/reagent/consumable/ethanol/ms13/absinthe = 75)
	grid_height = 96
	grid_width = 32
...
/obj/item/reagent_containers/food/drinks/bottle/ms13/rum
	...
	icon_state = "rum"
	volume = 80
	reagents_to_add = list(/singleton/reagent/consumable/ethanol/ms13/rum = 75)
	grid_height = 96
	grid_width = 32
...
/obj/item/reagent_containers/food/drinks/bottle/ms13/trooper_beer
	...
	icon_state = "beer"
	volume = 45
	reagents_to_add = list(/singleton/reagent/consumable/ethanol/ms13/beer = 40)
	w_class = WEIGHT_CLASS_SMALL
	grid_height = 64
	grid_width = 32

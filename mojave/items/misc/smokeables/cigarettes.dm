...
/obj/item/ms13/cigarette
	...
	var/chem_volume = 30
	var/reagents_to_add = list(/singleton/reagent/ms13/nicotine = 21) //used for tracking effects in body, not directly from reagent, 6 minutes of effect, butt is extra 1 minute
...
/obj/item/ms13/cigarette/butt //prespawned ciggie butts
	...
	reagents_to_add = list(/singleton/reagent/ms13/nicotine = 4.2)
	smoking_damage = 0.05
...
/obj/item/ms13/cigarette/salem
	...
	reagents_to_add = list(/singleton/reagent/ms13/nicotine/menthol = 21)

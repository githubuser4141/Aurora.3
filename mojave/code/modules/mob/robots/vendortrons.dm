...
/mob/living/simple_animal/hostile/retaliate/trader/ms13/robco/initial_products()
	return list(
		...
		/obj/item/cell/ms13/ec = list(50, rand(1,3)),
		/obj/item/cell/ms13/mfc = list(80, rand(1,2)),
		/obj/item/cell/ms13/ecp = list(100, rand(0,2)),
...
/mob/living/simple_animal/hostile/retaliate/trader/ms13/drought/crimson/initial_products()
	return list(
		...
		/obj/item/cell/ms13/ec = list(40, rand(0,3)),

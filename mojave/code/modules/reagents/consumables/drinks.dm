...
/singleton/reagent/consumable/ms13/water // When you code it
	name = "water"
...
/singleton/reagent/consumable/ms13/water/expose_turf(turf/open/exposed_turf, reac_volume) // easiest paste of my life
	. = ..()
...
/singleton/reagent/consumable/ms13/water/expose_obj(obj/exposed_obj, reac_volume)
	. = ..()
	if(reac_volume >= 20)
		exposed_obj.extinguish()
		exposed_obj.wash(CLEAN_TYPE_ACID)

/singleton/reagent/consumable/ms13/water/unfiltered
...
/singleton/reagent/consumable/ms13/water/dirty
	name = "Dirty Water"
...
/singleton/reagent/consumable/ms13/water/dirty/on_mob_life(mob/living/carbon/M, delta_time, times_fired)
	M.adjust_disgust(5)
	if(prob(50))
		M.adjustToxLoss(1.5)
...
/singleton/reagent/consumable/ms13/nuka_cola
	name = "Nuka-Cola"
...
/singleton/reagent/consumable/ms13/nuka_diet
	name = "Nuka-Diet"
...
/singleton/reagent/consumable/ms13/nuka_diet/on_mob_life(mob/living/carbon/M, delta_time, times_fired)
	if(prob(5))
		M.adjustBruteLoss(0.5) //aspartame is bad for your bones. Shoulda just drank water.

/singleton/reagent/consumable/ms13/nuka_cherry
	name = "Nuka-Cherry"
...
/singleton/reagent/consumable/ms13/nuka_grape
	name = "Nuka-Grape"
...
/singleton/reagent/consumable/ms13/nuka_orange
	name = "Nuka-Orange"
...
/singleton/reagent/consumable/ms13/nuka_cranberry
	name = "Nuka-Cranberry"
...
/singleton/reagent/consumable/ms13/nuka_lemon
	name = "Nuka-Lemon"
...
/singleton/reagent/consumable/ms13/nuka_lime
	name = "Nuka-Lime"
...
/singleton/reagent/consumable/ms13/nuka_quantum
...
/singleton/reagent/consumable/ms13/nuka_quartz
...
/singleton/reagent/consumable/ms13/nuka_victory
...
/singleton/reagent/consumable/ms13/nuka_wild
	name = "Nuka-Wild"
...
/singleton/reagent/consumable/ms13/nuka_vaccinated //TBD
...
/singleton/reagent/consumable/ms13/nuka_vaccinated/on_mob_life(mob/living/carbon/M, delta_time, times_fired)
...
/singleton/reagent/consumable/ms13/nuka_fusion
	name = "Nuka-Fusion"
...
/singleton/reagent/consumable/ms13/nuka_berry
	name = "Nuka-Berry"
...
/singleton/reagent/consumable/ms13/newka_cola
	name = "newka-Cola"
...
/singleton/reagent/consumable/ms13/nuka_frutti // Grape/Orange/Cherry
	name = "Nuka-Frutti"
...
/singleton/reagent/consumable/ms13/nuka_love // Quartz and Cherry
	name = "Nuka-Love"
...
/singleton/reagent/consumable/ms13/nuka_rush //Victory and Wild
	name = "Nuka-Rush"
...
/singleton/reagent/consumable/ms13/nuka_free //Cola and Water
	name = "Nuka-Free"
...
/singleton/reagent/consumable/ms13/nuka_black //Cola and Coffee
	name = "Nuka-Black"
...
/singleton/reagent/consumable/ms13/vim_refresh
	name = "Vim Refresh"
...
/singleton/reagent/consumable/ms13/sunset_sarsaparilla
...
/singleton/reagent/consumable/ms13/gagquik // Vile stuff.
	name = "gagquik"
...
/singleton/reagent/consumable/ms13/gagquik/on_mob_life(mob/living/carbon/M, delta_time, times_fired) // This definitely won't be slipped into drinks
	if(prob(25))
		M.vomit(lost_nutrition = 25, distance = 1, purge_ratio = 0.5)
	M.adjust_disgust(10)
	return ..()

/singleton/reagent/consumable/ms13/redheave //Geigpunga wine, Toxic soot extract, Gagquik, CHEMICALS?
	name = "red heave"
...
/singleton/reagent/consumable/ms13/redheave/on_mob_life(mob/living/carbon/M, delta_time, times_fired)
...
/* Not doin this yet
/singleton/reagent/consumable/ms13/waster_tea // Ash Rose / Broc
	name = "waster's Tea"
...
/singleton/reagent/consumable/ms13/waster_tea/on_mob_life(mob/living/carbon/M, delta_time, times_fired)
	if(M.getFireLoss() && DT_PROB(10, delta_time))
		M.heal_bodypart_damage(1,0, 0)
		. = TRUE

/singleton/reagent/consumable/ms13/herb_brew // Coyote tobacco and lureweed
	name = "herbal Brew"
...
/singleton/reagent/consumable/ms13/herb_brew/on_mob_life(mob/living/carbon/M, delta_time, times_fired)
	M.adjustBruteLoss(-1)

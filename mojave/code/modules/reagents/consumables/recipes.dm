...
/datum/chemical_reaction/drink/ms13/nuka_frutti
	result = list(/singleton/reagent/consumable/ms13/nuka_frutti = 3)
	required_reagents = list(/singleton/reagent/consumable/ms13/nuka_grape = 1, /singleton/reagent/consumable/ms13/nuka_orange = 1, /singleton/reagent/consumable/ms13/nuka_cherry = 1)

/datum/chemical_reaction/drink/ms13/nuka_love
	result = list(/singleton/reagent/consumable/ms13/nuka_love = 2)
	required_reagents = list(/singleton/reagent/consumable/ms13/nuka_quartz = 1, /singleton/reagent/consumable/ms13/nuka_cherry = 1)

/datum/chemical_reaction/drink/ms13/nuka_rush
	result = list(/singleton/reagent/consumable/ms13/nuka_rush = 2)
	required_reagents = list(/singleton/reagent/consumable/ms13/nuka_victory = 1, /singleton/reagent/consumable/ms13/nuka_wild = 1)

/datum/chemical_reaction/drink/ms13/nuka_free
	result = list(/singleton/reagent/consumable/ms13/nuka_free = 2)
	required_reagents = list(/singleton/reagent/consumable/ms13/nuka_cola = 1, /singleton/reagent/consumable/ms13/water = 1)
